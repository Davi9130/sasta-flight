...
# Empty calendar / empty payload without HTTP 429 (soft IP block)
SEARCH_SILENT_BLOCK_COOLDOWN_SECS = float(
    os.getenv("SEARCH_SILENT_BLOCK_COOLDOWN_SECS", "3600")
)
...
MAX_STAY_DAYS = 90
MAX_HUB_NIGHTS = 14
MIN_SELF_TRANSFER_HOURS = float(os.getenv("MIN_SELF_TRANSFER_HOURS", "4"))
HUB_CONFIRM_POOL = int(os.getenv("HUB_CONFIRM_POOL", "4"))
